...
base_freq_filename = f"out_base_freq_laje{noise}.txt"
base_modes_filename = f"out_base_modes_laje{noise}.txt"
...
log_title = f"laje_GA_N{noise}" # alterar nome do arquivo gerado, se quiser
