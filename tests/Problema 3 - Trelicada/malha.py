...
malha = [0.015, 0.05, 0.1, 0.15, 0.2, 0.4, 0.8, 1, 1.25, 1.5, 2]
key = 'malha'

# Caminhos
base_dir = r"C:\Users\Thiago Artur\OneDrive\Documentos\2025.2\Problema 2"
...
csv_path = os.path.join(base_dir, f'resultado_sensibilidade_malha_{datetime.now().strftime("%Y%m%d_%H%M%S")}.csv')
