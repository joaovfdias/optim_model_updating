...
def BO_run_laje(acq_fun, rodada):
    ...
    print(f"\n\nRodada {rodada}: initial_points = {initial_points}, evaluations = {evaluations}, aqc_func = {acq_func}\n")
    ...
    result = rodada.run(evaluations, acq_func=acq_func, status=True)