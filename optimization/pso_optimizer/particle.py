...
class Particle(Individual):
    ...
    def initial_velocity(self, parameters, init_vel_ratio):
        self.velocity = [random.uniform(-init_vel_ratio,init_vel_ratio) * parameters[i].search_space for i in range(len(parameters))]
